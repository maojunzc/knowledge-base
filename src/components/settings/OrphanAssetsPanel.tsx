...
export default function OrphanAssetsPanel() {
  ...
  return (
    <div className="space-y-3">
      ...
      {scan && totalCount === 0 && (
        <Alert type="success" showIcon message="磁盘干净，没有未引用素材" />
      )}
...
function OrphanTabContent({
  ...
  if (group.count === 0) {
    return <Empty description="此类别下无未引用素材" image={Empty.PRESENTED_IMAGE_SIMPLE} />;
  }
